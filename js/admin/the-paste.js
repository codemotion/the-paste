			...
			if ( sub === 'blob:' ) {
				...
				xhr.onreadystatechange = function(){
					...
					if ( xhr.readyState == 4 ) {
						...
						reader.readAsDataURL( new Blob( [ xhr.response ], { type: 'image/jpeg' } ) );
					}
				}
				xhr.open( 'GET', src );
				xhr.send( null );
...
(function($,window,o){
	...
	wp.media.thepaste.view.DataSourceImageUploader = wp.media.View.extend({
		...
		setImageData : function( data ) {
			...
			this.$('[data-setting="format"] input[value="image/jpeg"]').prop( 'checked', true );
...
//		tagName:   'div',
		...
		initialize : function() {
			...
			_.defaults( this.options, {
				wpuploader		: null,
				defaultFileName	: document.querySelector('#post-title-0') ? document.querySelector('#post-title-0').value : l10n.pasted,
